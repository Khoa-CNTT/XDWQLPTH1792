...
function HostelUserGroup({ hostelUsers =[], limit = 8}) {
  const [anchorPopoverElement, setAnchorPopoverElement] = useState(null)
  const isOpenPopover = Boolean(anchorPopoverElement)
  const popoverId = isOpenPopover ? 'hostel-all-users-popover' : undefined
...
export default HostelUserGroup